...
<tr>
    ...
    <td colspan="3" bgcolor="#FFFFFF"><input type="text" style="width:580px"   value="EmailTheme"   check_str="主题" name="emailTheme">
     </td>
    </tr>
  	...
  	<tr>
    		...
    		<td colspan="3" bgcolor="#FFFFFF"><textarea  check_str="内容"  rows="20"      name="emailContent" style="width:578px; resize:none; height:300px;">EmailContent</textarea></td>
    </tr>
    <tr>
